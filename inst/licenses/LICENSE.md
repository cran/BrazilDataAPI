...
## Note on BrazilDataAPI 

The `BrazilDataAPI` package depends on three public RESTful APIs for accessing Brazilian data and global data related to Brazil:
...
In the `BrazilDataAPI` package, the API is used to **dynamically retrieve and display real-time indicators for Brazil**. 
